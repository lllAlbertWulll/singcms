                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="{$news.small_title}" type="text" name="small_title" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input value="{$news.description}" type="text" class="form-control" name="description"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="{$news.keywords}" type="text" class="form-control" name="keywords"
