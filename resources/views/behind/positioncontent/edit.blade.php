                    ...
                    <form class="form-horizontal" id="singcms-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <img style="display: none" id="upload_org_code_img" src="{$vo.thumb}" width="150"
                                     height="150">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" value="{$vo.url}" name="url" id="inputPassword3"
                                       placeholder="请url地址">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="news_id" value="{$vo.news_id}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <if condition="$vo['status'] eq 0">checked</if>
                                > 关闭
                            </div>
