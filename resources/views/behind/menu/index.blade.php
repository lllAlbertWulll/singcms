                ...
                <form action="/admin.php" method="get">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="type">
                            ...
                            <option value="1"
                            <if condition="$type eq 1">selected="selected"</if>
                            >后台菜单</option>
                            <option value="0"
                            <if condition="$type eq 0">selected="selected"</if>
                            >前端导航</option>
                        </select>
                    </div>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <volist name="menus" id="menu">
                                    <tr>
                                        <td><input size="4" type="text" name="listorder[{$menu.menu_id}]"
                                                   value="{$menu.listorder}"/></td>
                                        <td>{$menu.menu_id}</td>
                                        <td>{$menu.name}</td>
                                        <td>{$menu.m}</td>
                                        ...
                                        <td><span class="glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit"
                                                  attr-id="{$menu.menu_id}"></span> <a href="javascript:void(0)"
                                                                                       attr-id="{$menu.menu_id}"
